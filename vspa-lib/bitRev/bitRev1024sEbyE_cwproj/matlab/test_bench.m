...
%**************************************************************************
% Scope:
% Test bench for bitRev1024sEbyE
%
%**************************************************************************
%
% Revision History:
%  - version 1.0 : 17 April 2017
%**************************************************************************
...
input = (1:1024).';
input_shift = [input(513:end); input(1:512)];
...
%% Matlab bit-exact
[out_ext] = r_bitRev1024( input_reOrd );
...
dmemSaveHexFile( dram1, strrep([cwProj,'\test_vectors\bitRev1024sEbyE_output_be.hex'],'\',filesep));
