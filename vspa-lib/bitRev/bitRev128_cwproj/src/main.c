...
//! @brief          Input buffer.
// -----------------------------------------------------------------------------
vspa_complex_float16 input[128] __attribute__((aligned(2 * UPHW)));

// -----------------------------------------------------------------------------
//! @brief          Output buffer.
// -----------------------------------------------------------------------------
vspa_complex_float16 out[128] _VSPA_VECTOR_ALIGN;
...
void main(void) {
    ...
    bitRev128Invoke((vspa_complex_float16 *)out, (vspa_complex_float16 const *)input);
