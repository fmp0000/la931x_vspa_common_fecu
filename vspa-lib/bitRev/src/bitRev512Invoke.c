...
bool bitRev512Invoke(vspa_complex_float16 *pOut, vspa_complex_float16 const *pIn) {
    if (!ippu_is_busy()) {
        ...
        ippu_enable(bitRev512, IPPU_PEND_NONE | IPPU_MODE_16BIT); // Start IPPU
