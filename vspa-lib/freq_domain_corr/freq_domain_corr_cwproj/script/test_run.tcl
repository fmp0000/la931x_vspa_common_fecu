...
# ==============================================================================
#! @file            test_run.tcl
#! @brief           TCL script for testing Pilot Tracking implementation.
# ==============================================================================
...
set ReportPath    "../../doc/Freq_Domain_Corr_Report.csv"
...
jenkinsWriteReport "Freq_Domain_Corr_Report.csv" "Test Case,Total cycles,Test Status"
...
for {set TC_ind $TC_NUM_START} {$TC_ind <= $TC_NUM_END} {incr TC_ind} {
    ...
    restore -b "${tcDirPathIn}/ctrl.bin" m:[evaluate #x FREQ_DOMAIN_CORR_TEST_CTRL] 16bit

    # Load input
    restore -b "${tcDirPathIn}/inp.bin" m:[evaluate #x FREQ_DOMAIN_CORR_INP_OUT] 16bit
    
    # Load gain
    restore -b "${tcDirPathIn}/gain.bin" m:[evaluate #x &FREQ_DOMAIN_CORR_GAIN_CPX] 16bit
    ...
    # Get params
    set num_sbc      [evaluate #d  FREQ_DOMAIN_CORR_TEST_CTRL.num_sbc]
    set num_streams  [evaluate #d  FREQ_DOMAIN_CORR_TEST_CTRL.num_streams]

    # Get output size (half words) 
    set outSize [evaluate #d $num_sbc * $num_streams * 2]
    
    # Store output
    save -b m:[evaluate #x FREQ_DOMAIN_CORR_INP_OUT]#$outSize "${tcDirPathOut}/out.bin" -o 16bit
    ...
    if {$diffResult != $DIFF_FILE_MATCH} then {
        ...
        lappend Failures "Frequency domain correction - error for TC ${TC_num} ..."
    } 
    
    # Get number of cycles
    set cycles  [evaluate #d clk_cycles]
    ...
    puts $Report_File  "$TC_num, $cycles, $test_status"
    ...
    jenkinsWriteReport "Freq_Domain_Corr_Report.csv" "$TC_num, $cycles, $test_status"
}
