...
# ==============================================================================
#! @file            test_run.tcl
#! @brief           TCL script for testing LOG implementation.
# ==============================================================================
...
set ReportPath    "../../doc/Log_Report.csv"
...
puts $Report_File  "Test Case,Function,Total cycles,Test Status"
jenkinsWriteReport "Log_Report.csv" "Test Case,Function,Total cycles,Test Status"
...
for {set TC_ind $TC_NUM_START} {$TC_ind <= $TC_NUM_END} {incr TC_ind} {
    ...
    restore -b "${tcDirPathIn}/ctrl.bin" m:[evaluate #x LOG_TEST_CTRL] 16bit

    # Load input vector
    restore -b "${tcDirPathIn}/input.bin" m:[evaluate #x LOG_INP_BUFF] 16bit
    ...
    set inputLen [evaluate #d LOG_TEST_CTRL.inputLen]  
    set outSize  [evaluate #d $inputLen * 2]

    # Store output
    save -b m:[evaluate #x LOG_OUT_BUFF]#$outSize "${tcDirPathOut}/out.bin" -o 16bit
    ...
    if {$diffResult != $DIFF_FILE_MATCH} then {
        ...
        lappend Failures "Log output error for TC ${TC_num} ..."
    } 
    ...
    jenkinsWriteReport "Log_Report.csv" "$TC_num, $cycles, $test_status"
}
