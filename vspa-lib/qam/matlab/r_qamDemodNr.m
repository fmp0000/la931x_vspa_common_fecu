...
% Copyright The - 2025 the original authors
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function y_bx= r_qamDemodNr(qamIn,M,snr)
%
% DESCRIPTION:
...
%
% NOTE:
%   The sign of LLRs are negated with respect to the previous version of V2
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
switch (M)
    case 2
        ...
        llrs=r_smad(r_half_flt(llrs).',snr1*ones(size(llrs.')),zeros(size(llrs.')));
    case 8
